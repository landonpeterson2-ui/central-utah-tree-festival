...
- [ ] **Get Web3Forms API key** - Form submissions will fail without this
  - Go to [web3forms.com](https://web3forms.com)
  - Enter your email to get free access key
  - Replace `YOUR_WEB3FORMS_ACCESS_KEY` in `volunteers.html` line 217

### Required Before Launch
- [ ] **Test the form** - Submit a test entry and verify you receive the email
- [ ] **Verify redirect URL** - Form redirects to `https://centralutahtreefestival.org/volunteers.html?success=true`
  - If your domain is different, update line 220 in `volunteers.html`
...
- [ ] Open `volunteers.html` and replace `YOUR_WEB3FORMS_ACCESS_KEY` on line 170 with your actual key
